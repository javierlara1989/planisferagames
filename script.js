document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        es: {
            ...
            sobreforjadoTitle: "Stone Into Gold",
            sobreforjadoDescription: "Heredas la vieja forja de tu abuelo y debes levantarla de nuevo. Mina o compra minerales, fúndelos en el horno, forja y cose objetos, templa y pule tus creaciones, y expónlas en los estantes para que los clientes las compren. Cada cierto número de días llega el cobrador de impuestos: si no hay oro suficiente, la forja se pierde. Un juego de gestión y crafteo con estilo pixel-art 16-bit.",
            patreonBtn: "Patreon",
            youtubeBtn: "YouTube",
        ...
        en: {
            ...
            sobreforjadoTitle: "Stone Into Gold",
            sobreforjadoDescription: "You inherit your grandfather's old forge and must build it back up. Mine or buy minerals, melt them in the furnace, forge and sew items, temper and polish your creations, and display them on the shelves for customers to buy. Every so many days the tax collector arrives: if there isn't enough gold, the forge is lost. A crafting and management game with 16-bit pixel-art style.",
            patreonBtn: "Patreon",
            youtubeBtn: "YouTube",
        ...
        pt: {
            ...
            sobreforjadoTitle: "Stone Into Gold",
            sobreforjadoDescription: "Você herda a velha forja do seu avô e precisa reconstruí-la. Extraia ou compre minérios, funda-os na fornalha, forje e costure itens, tempere e polha suas criações, e exponha-as nas prateleiras para os clientes comprarem. A cada certo número de dias chega o cobrador de impostos: se não houver ouro suficiente, a forja é perdida. Um jogo de gestão e criação com estilo pixel-art 16-bit.",
            patreonBtn: "Patreon",
            youtubeBtn: "YouTube",
